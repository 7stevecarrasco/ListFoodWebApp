...
namespace ListFoodWebApp.Controllers
{
    ...
    public class ListOrders : Controller
    {
        private readonly ApplicationDbContext _context;

        public ListOrders(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var resultsOrderList = _context.Orders.Include(o => o.Event).Include(o => o.User);
            return View(await resultsOrderList.ToListAsync());
        }
